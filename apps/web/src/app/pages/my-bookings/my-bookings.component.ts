...
<div class="page-container">
  ...
  <div class="filter-tabs">
    <button [class.active]="filter() === 'all'" (click)="filter.set('all')">Todos ({{ allBookings().length }})</button>
    <button [class.active]="filter() === 'upcoming'" (click)="filter.set('upcoming')">Próximos ({{ upcomingCount() }})</button>
