...
<div class="page-container">
  ...
  <div class="stats-grid">
    <div class="stat-card"><div class="stat-value">{{ stats()?.totalUsers }}</div><div class="stat-label">Usuarios</div></div>
    ...
    <div class="stat-card"><div class="stat-value">{{ stats()?.globalOccupancy }}%</div><div class="stat-label">Ocupación</div></div>
  </div>
